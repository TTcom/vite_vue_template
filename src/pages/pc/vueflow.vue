<script setup>
import { ConnectionMode, ConnectionLineType,MiniMap, Position, VueFlow, useVueFlow } from "@braks/vue-flow"
import { computed, h, onMounted, ref } from "vue"
import ColorSelectorNode from "~/components/flows/custom.vue"
const presets = {
  sumi: "#1C1C1C",
  gofun: "#FFFFFB",
  byakuroku: "#A8D8B9",
